...
import { BuffetPackage, initialTables, OrderItem, StationOrder, TableInfo } from "../../data/posMenuData";
import { TableGrid } from "../../components/pos/TableGrid";
import { TableDetail } from "../../components/pos/TableDetail";
import { useAppContext } from "../../../contexts/AppContext";
import { addOrderItems, createOrder, getTables, processPayment } from "../../../services/api";

const SHARED_DATA_UPDATE_KEY = 'bimaresto:data-sync';

export default function POSDashboard() {
  const { menus, categories, tables: backendTables, apiError, manualRefresh, isLoading } = useAppContext();
