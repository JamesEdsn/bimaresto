...
export default function MenusPage() {
  ...
  const toggleAvailability = (id: number) => {
    ...
    toggleMenuAvailability(id, current?.is_available ?? false);
  };
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-slate-950 text-[24px] font-bold">Menu Management</h1>
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-slate-900 w-64"
              />
            </div>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredMenus.map((menu) => (
            ...
            >
              ...
              <div className="relative h-48 bg-slate-100 flex items-center justify-center">
                ...
                {!menu.is_available && (
                  <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                    <span className="px-4 py-2 bg-red-500 text-white text-[14px] font-medium rounded-lg">
                      Unavailable
                    </span>
                  </div>
                )}
              ...
              <div className="p-4">
                <div className="mb-3">
                  <h3 className="text-slate-950 text-[16px] font-bold mb-1">{menu.name}</h3>
                  <p className="text-slate-500 text-[12px]">{menu.category?.name}</p>
                </div>

                <div className="flex items-center justify-between mb-4">
                  <span className="text-slate-950 text-[20px] font-bold">{formatCurrency(menu.price)}</span>
                  <button
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full border border-slate-200 max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <form onSubmit={handleAddMenu} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-slate-900 flex items-center justify-center gap-2">
              ...
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                <div className="flex items-center justify-between">
                  <div>
                    <label className="block text-gray-300 text-[13px] font-medium mb-1">
                      Availability Status
                    </label>
