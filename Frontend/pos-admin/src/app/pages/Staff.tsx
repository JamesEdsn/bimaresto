...
import { createStaff, deleteStaffById, getRoles, getStaff, updateStaffById } from '../../services/api';
...
export default function StaffPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingStaff) {
      const updatedStaff = await updateStaffById(editingStaff.id, {
  ...
  const toggleStaffStatus = async (id: number) => {
    ...
    const updatedStaff = await updateStaffById(id, {
