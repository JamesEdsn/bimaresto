...
import { TableInfo, stations, StationOrder } from "../../data/posMenuData";
        ...
        <div className="p-5 border-t border-gray-100 flex gap-3 flex-shrink-0">
          ...
          {hasUnsent && (
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-orange-500 text-white disabled:bg-gray-300 transition text-sm flex items-center justify-center gap-2"
            >
