          ...
          {occupiedTables.length === 0 ? (
            ...
            <div className="space-y-2">
              {occupiedTables.map((t) => {
                const tTotal = t.orders.reduce((s, o) => s + o.price * o.quantity, 0);
                const tItems = t.orders.reduce((s, o) => s + o.quantity, 0);
                return (
                  <button
                    key={t.id}
            ...
            <div className="mt-4 p-3 bg-indigo-50 border border-indigo-200 rounded-xl">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-700">
                ...
                <span className="text-indigo-700">
                  {currentTable.orders.reduce((s, o) => s + o.quantity, 0) + selectedInfo.orders.reduce((s, o) => s + o.quantity, 0)} item
                </span>
              </div>
            </div>
          )}
